...
uint16_t Channel::get_id() { return id; }

void Channel::set_id(int val) { id = val; }
...
void ChannelGroup::select(bool value) { selected = value; }

void ChannelGroup::group(bool value) { this->grouped = value; }
void ChannelGroup::enable(bool value) { this->enabled = value; }

bool ChannelGroup::is_grouped() const { return grouped; }

bool ChannelGroup::is_enabled() const { return enabled; }
